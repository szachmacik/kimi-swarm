...
const systemPrompt = `You are the AI Guardian for Kimi Swarm — AI Agent Orchestration on ofshore.dev.

About this application:
Kimi Swarm — AI Agent Orchestration

Features:
- 83+ AI function registry
- Multi-agent task orchestration
- Kimi agent management
- Cost calculator for AI operations
- Integration logs
...
router.get("/health", (_req, res) => {
  res.json({
    status: "ok",
    app: "Kimi Swarm — AI Agent Orchestration",
